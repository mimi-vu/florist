...
export const FLOWERS: FlowerMeta[] = [
  { id: 'spider-lily-white',   name: 'White Spider Lily',    latin: 'Lycoris albiflora',        seasonal: 'Late summer', hasModel: true, tint: '#fffaf3', credit: FFISH },
  { id: 'spider-lily-gold',    name: 'Golden Spider Lily',   latin: 'Lycoris traubii',          seasonal: 'Autumn',      hasModel: true, tint: '#f5b301', credit: FFISH },
  { id: 'spider-lily-red',     name: 'Red Spider Lily',      latin: 'Lycoris radiata',          seasonal: 'Autumn',      hasModel: true, tint: '#c8102e', credit: FFISH },
  { id: 'rain-lily-pink',      name: 'Pink Rain Lily',       latin: 'Zephyranthes carinata',    seasonal: 'Summer',      hasModel: true, tint: '#f4a1b8', credit: FFISH },
  { id: 'statice-purple',      name: 'Purple Statice',       latin: 'Limonium sinuatum',        seasonal: 'Summer',      hasModel: true, tint: '#7a5fbf', credit: FFISH },
  { id: 'wisteria',            name: 'Japanese Wisteria',    latin: 'Wisteria floribunda',      seasonal: 'Spring',      hasModel: true, tint: '#a58bd0', credit: FFISH },
  { id: 'chrysanthemum',       name: 'Chrysanthemum',        latin: 'Chrysanthemum cv.',        seasonal: 'Autumn',      hasModel: true, tint: '#f0c04a', credit: FFISH },
  { id: 'buttercup-japanese',  name: 'Japanese Buttercup',   latin: 'Ranunculus japonicus',     seasonal: 'Spring',      hasModel: true, tint: '#ffd23f', credit: FFISH },
  { id: 'buttercup-spinyfruit',name: 'Spinyfruit Buttercup', latin: 'Ranunculus muricatus',     seasonal: 'Spring',      hasModel: true, tint: '#f5b301', credit: FFISH },
  { id: 'hydrangea-lace',      name: 'Lace Hydrangea',       latin: 'Hydrangea luteovenosa',    seasonal: 'Early summer',hasModel: true, tint: '#e8e2c8', credit: FFISH },
  ...
  { id: 'skunkvine',           name: 'Skunkvine',            latin: 'Paederia foetida',         seasonal: 'Summer',      hasModel: true, tint: '#d9b8c4', credit: FFISH },
